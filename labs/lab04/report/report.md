...
Написала код программы по заданию.
...
Транслировала файл командой nasm с дополнительными опциями.Получился файл листинга и объектный файл.

Выполнила компановку и получила исполняемый файл.

Еще раз выполнила компановку для второго объектного файла и получила новый исполняемый файл.

Запустила исполняемые файлы.

![Компиляция и запуск программы](image/03.png){ #fig:003 width=70%, height=70% }

Изменила сообщение Hello world на свое имя и запустил файл еще раз.
